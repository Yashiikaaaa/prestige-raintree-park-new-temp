...
{ name: "Kauvery Hospital", distance: "5 km" }
    ...
    schools: [
    { name: "Glentree Academy", distance: "3 km" },
{ name: "Vibgyor School", distance: "3 km" },
{ name: "Cambridge International School", distance: "5 km" },
{ name: "Ryan International", distance: "7 km" }
    ],
    connectivity: [
      { name: "Brigade IRV Center", distance: "3 km" },
{ name: "Embassy Tech Village", distance: "7 km" },
{ name: "Prestige Tech Park", distance: "5 km" },
{ name: "ORR", distance: "6 km" },
{ name: "Sarjapur Road", distance: "8 km" }
    ],
